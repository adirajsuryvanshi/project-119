...
def stem_words(words, ignore_words):
    ...
    for word in words:
        ...
        if word not in ignore_words:
            ...
            # Define stemmed_words variable if it doesn't exist
            if not stemmed_words:
                stemmed_words = []
            # Append stemmed word to list
...
def create_bot_corpus(words, classes, pattern_word_tags_list, ignore_words):
    ...
    stem_words = stem_words(words, ignore_words)
    ...
    classes.sort()
    # print stem_words
    print('stem_words list : ' + str(stem_words))
...
def bag_of_words_encoding(stem_words, pattern_word_tags_list):
    ...
    for word_tags in pattern_word_tags_list:
        ...
        stemmed_pattern_words = stem_words(pattern_words, ignore_words)
        # Input data encoding
        # Take a word from stem_words list
        # Check if that word is in stemmed_pattern_words
        # Append 1 in BOW, otherwise append 0
        for stemmed_pattern_word in stemmed_pattern_words:
            if stemmed_pattern_word in stem_words:
